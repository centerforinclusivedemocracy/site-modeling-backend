...
# 2015: Main (only CA residents)  **UPDATED TO 2017 from 2015 (Feb 2020) ****
...
setwd("/Users/lauradaly/Documents/GreenInfo/Contract Work/Siting Tool/data/output")
...
setwd("/Users/lauradaly/Documents/GreenInfo/Contract Work/Siting Tool/data/output/visualize")
